...
if __name__ == "__main__":
    ...
    # Actions
    #################
    parser.add_argument('--evaluate', action='store_true', help='Evaluate classification accuracy')
    parser.add_argument('--visualize_latent', action='store_true', help='Visualize latent space by class')
